...
class TextBmhFormat : public ITextProvider {
   public:
    ...
    // ITextProvider
    //=========================
    auto GetRequiredSizeCharacter(char character) const -> const Vec2D override;
    auto GetRequiredSizeString(const std::string& text, uint8_t spacing) const -> const Vec2D override;
    ...
    */
    ...
    auto GetFont() const -> const BmhFont*;
    ...
    */
    auto GetCharacterIndex(const char character) const -> const uint8_t;
